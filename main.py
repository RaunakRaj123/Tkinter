...
def query():
    ...
    mycursor.execute("insert into registration(%s,%s,%s,%s)",(entry_1.get(),entry_2.get(),var.get(),entry_3.get()))
    conn.commit()
...
b=Button(root, text='Submit',width=20,bg='brown',fg='white',command=query)
b.place(x=180,y=380)
